  ...
  const actionColumn = [
    {
      ...
      renderCell: (params) => (
        <>
          <Link to={`/organization/create/${params.row.id}`}>
    ...
    <>
      <header className='p-8'>
        <div className='flex justify-between pb-6'>
          <h2 className='text-xl text-white'>All Organizations</h2>
          <Button type="primary" htmlType="submit" style={{ margin: "0px 10px", backgroundColor: "limegreen" }} className='punch' onClick={() => navigate('/organization/create')}>
            Add Organization
          </Button>
        </div>
